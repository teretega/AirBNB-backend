 ...
 *
 * Usage:
 *   node data/seed.js              # skips collections that already have data
 *   node data/seed.js --force      # wipes and re-seeds all collections
 *   node data/seed.js --only stay  # seed a single collection
 */
